      ...
      <div className="w-full py-6 z-20">
        ...
        <div action className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto mb-10">
          <div className="pb-2 pt-4">
            <input type="email" onChange={formik.handleChange}  name="email" id="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm mb-1 bg-black" />
            {eroremail!==null?(
          ...
          <div className="pb-2 pt-4">
            <input onChange={formik.handleChange}  className="block w-full p-4 text-lg rounded-sm bg-black mb-1" type="password" name="password" id="password" placeholder="Mật khẩu" />
            {erorpass!==null?(
          ...
          <div className="px-4 pb-2 pt-4">
            <button className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none" type="submit">Đăng nhập</button>
          </div>
          <div className="text-right text-gray-400 hover:underline hover:text-gray-100">
