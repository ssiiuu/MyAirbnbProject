...
var PopoverContent = function PopoverContent(_ref) {
  ...
  return react.jsx(React__default.Fragment, null, showBadge ? react.jsx(Badge, {
    styles: styles
  }, badge) : null, showCloseButton ? react.jsx(Close, {
    styles: styles,
    "aria-label": accessibilityOptions == null ? void 0 : accessibilityOptions.closeButtonAriaLabel,
    disabled: disabledActions,
    onClick: closeClickHandler
  }) : null, react.jsx(Content, {
    ...
    isHighlightingObserved: isHighlightingObserved,
    setIsOpen: setIsOpen
  }), showNavigation ? react.jsx(Navigation, {
    setCurrentStep: setCurrentStep,
    currentStep: currentStep,
    setIsOpen: setIsOpen,
    steps: steps,
...
var Tour = function Tour(_ref) {
  ...
  return step ? React__default.createElement(utils.Portal, null, React__default.createElement(FocusManager, {
  ...
  }, ContentComponent ? React__default.createElement(ContentComponent, Object.assign({
    styles: styles,
    setCurrentStep: setCurrentStep,
    currentStep: currentStep,
    setIsOpen: setIsOpen,
    ...
    isHighlightingObserved: isHighlightingObserved,
    rtl: rtl
  }, popoverProps)) : React__default.createElement(PopoverContent, Object.assign({
    styles: styles,
    setCurrentStep: setCurrentStep,
    currentStep: currentStep,
    setIsOpen: setIsOpen,
